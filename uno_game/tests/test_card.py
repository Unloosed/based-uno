...
class TestCard(unittest.TestCase):
    ...
    def test_wild_card_creation(self):
        ...
        self.assertEqual(
            wild_card.active_color, Color.WILD
        )  # Active color starts as WILD
    ...
    def test_is_special_action(self):
        ...
        self.assertFalse(
            Card(Color.WILD, Rank.WILD).is_special_action()
    ...
    def test_card_matches(self):
        ...
        self.assertTrue(
            blue_card.matches(wild_on_table, current_color_chosen_for_wild=Color.BLUE)
        )
        self.assertFalse(
