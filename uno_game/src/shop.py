...
if __name__ == "__main__":
    ...
    success, msg = shop.purchase_item(player_alice, ShopEffectId.GAIN_SHUFFLE_TOKEN.value)
    ...
    success, msg = shop.purchase_item(player_alice, "non_existent_item") # Test with a raw string for invalid
